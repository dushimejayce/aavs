        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Jean Claude DUSHIME</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{asset('images/jayce.jpg')}}" class="img-circle" alt="User Image">

                <p>
                  Jean Claude DUSHIME - Web Developer
