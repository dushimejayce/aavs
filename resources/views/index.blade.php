...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>AAVS -Specialised In Civil Construction Work</title>
            ...
            <div class="top_nav">
                <div class="container">
                    <ul class="list-inline info">
                        <li><a href="#"><span class="fa fa-phone"></span> (+250)788602849</a></li>
                        <li><a href="#"><span class="fa fa-envelope"></span> aavscompany@gmail.com</a></li>
                        <li><a href="#"><span class="fa fa fa-home"></span> Location:  Kigali-Gasabo</a></li>
                    </ul>
            ...
            <div class="container">
                ...
                <div class="col-md-4">
                        <div class="service_item">
                            <img src="{{$service->image}}" alt="Our Services" />
                            <h3>{{$service->name}}</h3>
        ...
        <footer>
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-7">
                        <div class="footer_item">
                            ...
                            <p>AAVS Company ltd specialise in civil construction work,structural, steel fabrications,electrical fitting,plumbing fittings,retrofitting of concrete and steel structures. It also conducts the supervision of projects.</p>
                    ...
                    <div class="col-lg-3 col-sm-7">
                        <div class="footer_item">
                            ...
                            <ul class="list-unstyled post">
                                <li><a href=""><span class="date">20 <small>AUG</small></span>  Construction of building of two level In nyagatare sector</a></li>
                                <li><a href=""><span class="date">15 <small>JUL</small></span>  building of road from Ngoma to Murambi</a></li>
                                <li><a href=""><span class="date">10 <small>MAY</small></span>  Rehabilitation of health center in Rwinkwavu sector</a></li>
                    ...
                    <div class="col-lg-3 col-sm-5">
                        <div class="footer_item">
                            ...
                            <ul class="list-unstyled footer_contact">
                                <li><a href=""><span class="fa fa-map-marker"></span> KG 125 KIGALI GASABO<a></li>
                                <li><a href=""><span class="fa fa-envelope"></span> aavscompany@gmail.com</a></li>
                                <li><a href=""><span class="fa fa-mobile"></span><p>(+250)788602849 <br />(+250)788602849</p></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer_bottom text-center">
                <p class="wow fadeInRight">
                    ...
                    by 
                    <a target="_blank" href="http://bootstrapthemes.co">AAVS</a> 
